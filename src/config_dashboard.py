    ...
    try:
        ...
        def run_strategy():
            ...
            try:
                ...
                print(f"[LIVE TRADER] Strategy file: {strategy_file}")
                print(f"[LIVE TRADER] Working directory: {strategy_cwd}")
                print(f"[LIVE TRADER] File exists: {os.path.exists(strategy_file)}")
                ...
                def monitor_process():
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(f"[STRATEGY] Error checking process status: {e}")
                            strategy_running = False
                            if strategy_process == proc:
                                strategy_process = None
